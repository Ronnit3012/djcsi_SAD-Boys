    ...
    <section className='grid grid-cols-4 p-4'>
      {
        paints.map(paint => {
          return (
              <div className=" rounded-lg  shadow-lg dark:bg-neutral-700 bg-slate-200 m-3 text-center">
                <div className="flex flex-col justify-content items-center p-3">
                  <div className='w-32 h-32' style={{ backgroundColor: `${paint.hex}` }}></div>
                </div>
